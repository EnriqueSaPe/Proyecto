...
--
-- Host: localhost    Database: bd_youtube_2022
-- ------------------------------------------------------
...
CREATE TABLE `tb_videos` (
  ...
  `Estatus` enum('Disponible','No Disponible','Bloqueado','En Revision') NOT NULL,
  `Total_Reproducciones` int unsigned DEFAULT '0',
...
-- Dump completed on 2022-01-06 14:38:04
